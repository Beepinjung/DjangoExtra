...
from django import forms  # <-- keep your imports intact
...
def task_edit(request, pk):
    ...
    # If secret and not unlocked, redirect to unlock page
...
def secret_task_detail(request, pk):
    ...
    if not task.is_secret:
        # Redirect normal task detail if not secret
...
def task_detail(request, pk):
    # Show detail for non-secret task
